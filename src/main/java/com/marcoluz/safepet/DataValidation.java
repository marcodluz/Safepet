...
public class DataValidation {
  ...
  public static boolean textFieldNull(
  ...
  public static boolean datePickerNull(
  ...
  public static boolean comboBoxNull(
  ...
  public static boolean passwordFieldNull(
    PasswordField inputTextField,
    Label inputLabel,
    String validationText
  ) {
    boolean isNull = false;
  ...
  public static boolean charOnly(
    TextField inputTextField,
    Label inputLabel,
    String validationText
  ) {
