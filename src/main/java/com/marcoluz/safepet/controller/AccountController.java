...
public class AccountController implements Initializable {
  ...
  public void updateAccount(ActionEvent event)
    ...
    boolean oldPasswordValidatorNull = DataValidation.passwordFieldNull(
      accountPassword,
      oldPasswordError,
      "Enter a password"
    );
    boolean oldPasswordCheck = AccountDAO.checkPassword(
      accountPassword,
      oldPasswordError,
      "Wrong Password"
    );
    ...
    if (
      ...
      AnchorPane pane = FXMLLoader.load(
        getClass().getResource("/com/marcoluz/safepet/account-success.fxml")
      );
