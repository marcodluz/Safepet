...
public class AddPetController {
  ...
  public void createPet(ActionEvent event) throws IOException {
    boolean petNameValidatorChar = DataValidation.charOnly(
      petName,
      petNameError,
      "Only characters"
    );
    boolean petNameValidatorNull = DataValidation.textFieldNull(
      petName,
      petNameError,
      "Enter your pet's name"
    );
    boolean petSpecieValidatorChar = DataValidation.charOnly(
      petSpecie,
      petSpecieError,
      "Only characters"
    );
    boolean petSpecieValidatorNull = DataValidation.textFieldNull(
      petSpecie,
      petSpecieError,
      "Enter your pet's specie"
    );
    boolean petDOBValidatorNull = DataValidation.datePickerNull(
      petDatePicker,
      petDobError,
      "Select your pet's date of birth"
    );
    boolean petCoatColourValidatorChar = DataValidation.charOnly(
      petCoatColour,
      petCoatColourError,
      "Only characters"
    );
    boolean petCoatColourValidatorNull = DataValidation.textFieldNull(
      petCoatColour,
      petCoatColourError,
      "Enter your pet's coat colour"
    );

    if (
      petNameValidatorChar &&
      !petNameValidatorNull &&
      petSpecieValidatorChar &&
      !petSpecieValidatorNull &&
      petCoatColourValidatorChar &&
      !petDOBValidatorNull &&
      !petCoatColourValidatorNull
    ) {
      ...
      String SQL =
        "INSERT INTO pet (id, account_id, name, specie, coat_colour, dob, notes) values (?, ?, ?, ?, ?, ?, ?);";
