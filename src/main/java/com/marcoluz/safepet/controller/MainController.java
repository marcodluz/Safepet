...
public class MainController {
  ...
  public void createAccount(ActionEvent event)
    ...
    boolean firstNameValidatorChar = DataValidation.charOnly(
      customer_firstname,
      firstNameError,
      "Only characters"
    );
    boolean firstNameValidatorNull = DataValidation.textFieldNull(
      customer_firstname,
      firstNameError,
      "Enter your first name"
    );
    boolean lastNameValidatorChar = DataValidation.charOnly(
      customer_lastname,
      lastNameError,
      "Only characters"
    );
    boolean lastNameValidatorNull = DataValidation.textFieldNull(
      customer_lastname,
      lastNameError,
      "Enter your last name"
    );
    boolean emailValidatorNull = DataValidation.textFieldNull(
      customer_email,
      emailError,
      "Choose a valid address"
    );
    boolean emailValidatorFormat = DataValidation.emailFormat(
      customer_email,
      emailError,
      "Choose a valid address"
    );
    boolean emailExists = AccountDAO.checkEmailExists(
      customer_email,
      emailError,
      "Email already exists"
    );
    boolean passwordValidatorNull = DataValidation.passwordFieldNull(
      customer_password,
      passwordError,
      "Enter a password"
    );
    ...
    if (
      firstNameValidatorChar &&
      !firstNameValidatorNull &&
      lastNameValidatorChar &&
      !lastNameValidatorNull &&
      emailValidatorFormat &&
      !emailExists &&
      !emailValidatorNull &&
      !passwordValidatorNull
    ) {
      ...
      String insertsql =
        ...
        "VALUES (?, ?, ?, ?, crypt('" +
        customer_password.getText() +
        "', gen_salt('bf')));";

      AccountDAO.insertAccountDetails(insertsql, mydata);

      AnchorPane pane = FXMLLoader.load(
        getClass().getResource("/com/marcoluz/safepet/signup-success.fxml")
      );
  ...
  private void login(ActionEvent event) throws IOException, SQLException {
    ...
    if (
      AccountDAO.checkLoginDetails(
        customer_email.getText(),
        customer_password.getText()
      )
    ) {
      AnchorPane pane = FXMLLoader.load(
        getClass().getResource("/com/marcoluz/safepet/dashboard.fxml")
      );
      rootPane.getChildren().setAll(pane);
      ...
      id =
        AccountDAO.getId(customer_email.getText(), customer_password.getText());
      firstName =
  ...
  public void goToSignUp(ActionEvent event) throws IOException {
    AnchorPane pane = FXMLLoader.load(
      getClass().getResource("/com/marcoluz/safepet/signup.fxml")
    );
    rootPane.getChildren().setAll(pane);
  }
  ...
  private void handleClicks(ActionEvent event) throws IOException {
    ...
    if (event.getSource() == btnMyPets) {
      AnchorPane pane = FXMLLoader.load(
        getClass().getResource("/com/marcoluz/safepet/pets-page.fxml")
      );
      ...
      AnchorPane pane = FXMLLoader.load(
        getClass().getResource("/com/marcoluz/safepet/appointments-page.fxml")
      );
      contentArea.setBackground(
        new Background(
          new BackgroundFill(
      ...
      AnchorPane pane = FXMLLoader.load(
        getClass().getResource("/com/marcoluz/safepet/account.fxml")
      );
      middleRootPane.getChildren().setAll(pane);
